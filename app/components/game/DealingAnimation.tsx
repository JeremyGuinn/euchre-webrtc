...
export function DealingAnimation({
    ...
    const getCardTargetPosition = (playerId: string, cardIndex: number): { x: number; y: number; rotation: number } => {
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <div id="dealing-center" className="relative">
                    ...
                    {animatingCards.map(card => {
                        const targetPos = getCardTargetPosition(card.playerId, card.cardIndex);
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    transition: card.isAnimating ? 'transform 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)' : 'none',
                                }}
                            >
                                <CardBack size="medium" />
                            </div>
